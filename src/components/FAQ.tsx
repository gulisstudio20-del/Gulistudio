...
const faqs = [
  ...
  { q: 'האתר נבנה בקוד?', a: 'לחלוטין! בונה בקוד פתוח כלומר כל מה שעולה על רוחכם אפשר לנסות להכניס לאתר ולשנות כל מה שתרצו — רק תגידו לי מה :)' },
  ...
  { q: 'אפשר לשנות את האתר אחרי?', a: 'בהחלט! אך לאחר סגירת הפרויקט ומסירתו ללקוח, אם יהיו עוד שינויים כלשהם בהמשך ניתן לחזור לסבבי תיקונים ושינויים בתיאום איתי — רק צרו איתי קשר ואעזור לכם במה שצריך.' },
