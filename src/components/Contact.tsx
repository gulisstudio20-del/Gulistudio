        ...
        <div>
          ...
          <div data-reveal className="flex flex-col gap-5 mb-12 transition-all duration-700" style={{ opacity: 0, transform: 'translateY(20px)' }}>
            {[
              ...
              >
                <span className="w-8 h-8 flex items-center justify-center border transition-all duration-300 group-hover:border-orange-400"
          ...
          <div data-reveal className="p-5 border transition-all duration-700" style={{ borderColor: 'rgba(255,92,26,0.2)', background: 'rgba(255,92,26,0.03)', opacity: 0, transform: 'translateY(20px)' }}>
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-xs tracking-widest uppercase" style={{ color: 'var(--orange)' }}>פתוחה לפרויקטים</span>
            </div>
          </div>
        </div>
          ...
          {sent ? (
            ...
            <form onSubmit={e => { e.preventDefault(); setSent(true) }} className="flex flex-col gap-7">
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea
                  rows={4}
                  placeholder="ספרי לי על הפרויקט..."
                  required
                  value={form.message}
              ...
              <button
                ...
                style={{ background: 'var(--orange)', color: '#fff', borderRadius: 4 }}
