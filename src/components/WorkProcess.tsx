...
const steps = [
  { num: '01', title: 'שיחת אפיון', desc: 'רק אתם ואני. כל מה שיש לכם להגיד — תזרקו רעיונות. אני כאן בשביל להקשיב.' },
  { num: '02', title: 'תכנון מבנה האתר', desc: 'בואו נקשקש, אבל לא ככה — הרי כבר דיברנו מספיק. התכוונתי במחברת. תנו לי להכין לכם סקיצה יפה למבנה האתר החדש שלכם.' },
  { num: '03', title: 'עיצוב ואישור', desc: 'כן, הנה צבעתי ואפילו העברתי למחשב — מה אתם אומרים? מתחיל להיראות כמו אתר, לא?' },
  { num: '04', title: 'בניית האתר', desc: 'הופה — איך הציור הפך לקוד מסובך במחשב? אל תדאגו, נחזיר אותו חזרה להיות יפיפה על המסך שלכם.' },
  { num: '05', title: 'העלאה ומסירה', desc: 'בדיקות סופיות, חיבור למערכות סליקה, טפסים ורספונסיביות מובייל. ואל תדאגו — לא אשאיר אתכם ככה לבד. אסביר לכם כל מה שאתם צריכים לדעת על האתר החדש שלכם.' },
]
